                                ...
                                <div class="grid_16">
                                    ...
                                    <div class="grid_8 apropos">
                                        ...
                                        <p> 
                                           ...
                                           <select name="title" required type="text" placeholder="">
                                                <%
                                        ...
                                        <p> 
                                            ...
                                            <input id="secondemail" name="secondEmail" required type="email" >
                                        </p>


                                        <p> 
                                            <label for="mobile" class="uname" data-icon="t">   Mobile</label>
                                            <input id="mobile" name="mobile" required type="tel" placeholder="0718789987">
                                        </p>
                                        <p> 
                                    ...
                                    <div class="grid_8 competences">
                                        ...
                                        <p> 
                                            <label for="jobPrefered" class="uname" >  Preferred Job Title</label>
                                            <select name="jobPrefered">
                                                <%
                                                    List<JobTitle> jobTitles = ManagerDAO.searchAll(new JobTitle());
                                                    for (JobTitle jobTitle : jobTitles) {
                                                %>
                                                <option value="<%= jobTitle.getIdJobTitle()%>"><%= jobTitle.getJobTitle()%></option>
                                                <%}%>
