...
<div class="grid_16">
        ...
        <%
            String sectorID="",qualificationName="",awardingBody="",classification="";
            sectorID=request.getParameter("sectorID");
            if(sectorID.isEmpty()){
            %>
          <p>No Results.</p>
        <%
            ...
            List<Person> Lst = new PersonDAOImpl().searchCVSpecificProfQualification(sectorID, qualificationName, awardingBody, classification);
        if (Lst.size()==0) {
                %>
                <p>No Results.</p>
        <%
